...
namespace ExamQuery.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            keyValuePairs.Add("ksh", "12345678901234");
            keyValuePairs.Add("sfzh", "430422200001016976");
            keyValuePairs.Add("code", "votg");
            string rez = web.DoPost("http://111.160.75.143:9081/KWService/cjcx_G15Ajax.do?method=query", keyValuePairs);*/
        ...
        //中考查询界面
        public ActionResult ZhongKaoAction()
        {
            ViewBag.GaoKaoProvince = LoadProvinceAndCity(true).Data;
            ViewBag.GaoKaoProvince = ViewBag.GaoKaoProvince.data;
            return View();
        ...
        public JsonResult Query(Parameter parameter)
        {
            ...
            ExamQueryHelper.InsertStudentInfo(examinee);*/
                ...
                else if (parameter.QueryType == 4)
                {
                    ...
                    if (zkAdmissionsResult.Existence)
                    {
                        Session["zkAdmissionsResult"] = zkAdmissionsResult;
                    }
        ...
        public JsonResult LoadProvinceAndCity(bool Query)
        {
            ...
            foreach (XmlNode Province in nodeList)
            {
                ...
                if (Query)
                {
                    ...
                    if (Province.Attributes["AdmissionsUrl"].Value != null)
                    {
                        query.AdmissionsUrl = Province.Attributes["AdmissionsUrl"].Value;
                    }
                }
                else
                {
        ...
        public JsonResult GetCopywritingInfo(bool query)
        {
            ...
            {
                //pc
                writing.BtnText = "立即下载";
                writing.ImgUrl = "/Img/FooterUrl.png";
                writing.ImgClickUrl = "";
                writing.BtnClikeUrl = "http://a.app.qq.com/o/simple.jsp?pkgname=com.student.ischool";
            }
